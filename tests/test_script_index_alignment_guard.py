...
def test_accepted_research_tools_have_script_index_and_makefile_links():
    ...
    expected = {
        ...
        "research/run_archive_parameter_sweep_triage.py": "make archive-parameter-sweep-triage",
        "research/run_funding_context_replay.py": "make funding-context-replay",
        "research/run_funding_context_price_join.py": "make funding-context-price-join",
        "research/run_funding_threshold_sensitivity.py": "make funding-threshold-sensitivity",
...
def test_read_only_status_reports_have_json_make_targets():
    ...
    expected = {
        ...
        "record-operator-briefing": "scripts/report_operator_briefing.py --write-default-artifact",
