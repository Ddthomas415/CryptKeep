...
if importlib.util.find_spec("phase1_research_copilot.gateway.main") is None:
    pytest.skip("phase1_research_copilot.gateway.main not present in this repo checkout", allow_module_level=True)
