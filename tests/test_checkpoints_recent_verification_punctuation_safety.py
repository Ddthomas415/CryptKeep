...
def test_recent_verification_bodies_have_no_semicolons() -> None:
    for phase, body in _recent_verification_bodies():
        assert ";" not in body, (
            f"Phase {phase} verification body should not contain semicolons"
        )



def test_recent_verification_bodies_have_no_double_commas() -> None:
    for phase, body in _recent_verification_bodies():
        assert ",," not in body, (
            f"Phase {phase} verification body should not contain double commas"
        )
