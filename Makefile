...
OPERATOR_EVENT_SECRET_SCAN_ARGS = $(if $(OPERATOR_EVENT_PATH),--path $(OPERATOR_EVENT_PATH),) $(if $(OPERATOR_EVENT_REQUIRE_EVENTS),--require-events,) $(if $(OPERATOR_EVENT_EVIDENCE_DEST),--evidence-dest $(OPERATOR_EVENT_EVIDENCE_DEST),)
