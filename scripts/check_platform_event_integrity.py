...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate platform event journal envelope integrity."
    )
    ...
    report = check_platform_event_integrity(
    ...
    if args.evidence_dest:
        ...
        out_path = dest / f"platform-event-integrity-{stamp}.json"
    ...
    if args.json:
        ...
        print(f"platform event integrity: {verdict}")
