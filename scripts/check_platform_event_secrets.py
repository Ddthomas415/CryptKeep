...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Scan platform event journal payloads for unredacted secret-like fields."
    )
    ...
    report = scan_platform_event_journal(
    ...
    if args.evidence_dest:
        ...
        out_path = dest / f"platform-event-secret-scan-{stamp}.json"
    ...
    if args.json:
        ...
        print(f"platform event secret scan: {verdict}")
