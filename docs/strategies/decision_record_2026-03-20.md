# Strategy Decision Record — 2026-03-20

## Scope

This record reflects the current repo state on 2026-03-20.
...
- previous run: `2026-03-20T16:29:16Z`
- current run: `2026-03-20T17:11:17Z`
...
Comparison detail:
- `breakout_donchian` moved `degraded`; rank `1` -> `1`, decision `keep` -> `improve`.
