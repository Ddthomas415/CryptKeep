...
- Supervised paper mode can consume scanner-ranked symbols through `managed_symbols.source=scanner` with refresh-cached selection and freshness-bounded active-symbol preservation.
