...
**Claim:** "There are three cost surfaces." → **REFUTED: there are seven, plus a
seven-module backtest family.** My own earlier census was wrong; the census invariant
caught it. The newest surfaces are research-only funding context and price-action
forward-return reports; neither is promotion or campaign evidence.
