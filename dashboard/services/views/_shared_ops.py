...
def _apply_local_summary_overrides(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    local_kill_switch = vd._load_local_kill_switch_state()
    ...
    local_connections = vd._load_local_connections_summary()
    ...
    risk_overlay = vd._load_local_risk_overlay(
    ...
    local_system_guard = vd._load_local_system_guard_state()
...
def _load_local_risk_overlay(*, portfolio_total_value: float = 0.0) -> dict[str, Any] | None:
    ...
    kill_switch_on = bool(_view_data()._load_local_kill_switch_state())
