...
DIGEST_SOURCE_MAP = {
    ...
    "safety_warnings": "live_guard + system_guard + start_manager + collector_runtime",
    "freshness_panel": "collector runtime + latest live snapshot + strategy evidence artifact or labeled synthetic fallback",
    "mode_truth": "merged runtime trading config + services.bot.start_manager.decide_start + dashboard.services.promotion_ladder.build_promotion_readiness",
