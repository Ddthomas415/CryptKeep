...
13. Keep pattern/candlestick strategy research visible but behind the archive
    ...
    2026-07-22: price-action research pipeline wrapper is ready for independent
    ...
    accepted labels, forward-returns, and stability reports into one read-only
    artifact set; it adds no strategy, campaign, gate, execution, or
