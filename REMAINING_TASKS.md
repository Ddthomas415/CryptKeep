...
7. Implement the composite/hybrid parity backtest integration as a research-only
   proof and stop for independent review. Do not add a leaderboard row, paper
   campaign, or production path until the follow-up backtest proof is reviewed.
